...
from dais26_dentex.models.backbones import BackboneInfo, CRadioWrapper, DinoV2Wrapper
...
def test_cradio_wrapper_object_output():
    ...
    class FakeCradio(nn.Module):
        def forward(self, x):
            return FakeOut(torch.randn(x.shape[0], 1152), torch.randn(x.shape[0], 64, 1152))
