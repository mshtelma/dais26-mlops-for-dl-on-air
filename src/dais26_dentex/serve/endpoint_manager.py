...
def rollback_to_previous_champion(
    ...
    """Set @champion back to a previous version and update the endpoint to serve it.

    The `previous_version` must have been captured BEFORE the failed promotion
    (see capture_previous_champion / EndpointDeployResult.previous_champion).
    """
    import mlflow
    from databricks.sdk import WorkspaceClient
